...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "La Cocina De Yoli — Repostería artesanal" },
      {
        name: "description",
        content:
          "Repostería artesanal hecha con cariño. Tartas, bizcochos y dulces tradicionales elaborados a mano por Yoli.",
      },
      { name: "author", content: "La Cocina De Yoli" },
      { property: "og:site_name", content: "La Cocina De Yoli" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Playfair+Display:wght@500;600;700&family=Nunito:wght@400;500;600;700&display=swap",
      },
    ],
  }),
